...
export async function middleware(req) {
  ...
  // Allow access to the home route without checking login
  if (req.nextUrl.pathname === "/") {
    return NextResponse.next(); // Proceed without redirect
  }
  ...
  // Redirect authenticated users to home if they try to access sign-in or sign-up
  if (isAuth && (req.nextUrl.pathname === "/sign-in" || req.nextUrl.pathname === "/sign-up")) {
